...
if __name__ == '__main__':
    ...
    annot_path_train = '/home/liuhaiyang/Document/keras_Realtime_Multi-Person_Pose_Estimation-master/keras_Realtime_Multi-Person_Pose_Estimation-master/dataset/annotations/person_keypoints_train2014.json'#os.path.join(curr_dir, '../dataset/annotations/person_keypoints_train2014.json')
    img_dir_train = '/home/liuhaiyang/Document/keras_Realtime_Multi-Person_Pose_Estimation-master/keras_Realtime_Multi-Person_Pose_Estimation-master/dataset/train2014/'#os.path.abspath(os.path.join(curr_dir, '../dataset/train2014/'))
    annot_path_val = '/home/liuhaiyang/Document/keras_Realtime_Multi-Person_Pose_Estimation-master/keras_Realtime_Multi-Person_Pose_Estimation-master/dataset/annotations/person_keypoints_val2014.json'#os.path.join(curr_dir, '../dataset/annotations/person_keypoints_val2014.json')
    img_dir_val = '/home/liuhaiyang/Document/keras_Realtime_Multi-Person_Pose_Estimation-master/keras_Realtime_Multi-Person_Pose_Estimation-master/dataset/val2014/'#os.path.abspath(os.path.join(curr_dir, '../dataset/val2014/'))
